<script>
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            alert(
                "Error connecting to the server. Make sure the Flask server is running.",
            );
            console.error(err);
        } finally {
            submitting = false;
    ...
    <div class="container">
        <ScrollReveal>
            <div class="contact-header">
                <h2 data-content-id="contact_headline">
                    {content.contact_headline}
                </h2>
                <p data-content-id="contact_subheadline">
            ...
            <ScrollReveal delay={200}>
                <div class="contact-sidebar">
                    <div class="sidebar-block">
                        ...
                        <p>
                            Drop us a message on WhatsApp and we'll respond
                            quickly.
                        </p>
                        <a
                    ...
                    <div class="sidebar-block sidebar-info">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">Chennai, India</div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Working Hours</div>
                            <div class="info-value">Anytime</div>
                        </div>
                    </div>
                </div>
            </ScrollReveal>
